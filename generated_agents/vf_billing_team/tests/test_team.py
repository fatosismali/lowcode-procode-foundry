"""Smoke tests for the "vf-billing-team" team orchestration."""
...
async def test_run_team_smoke():
    ...
    """
    result = await orchestrator.run_team("{\"userQuery\": \"How much is my latest bill and has it been paid?\", \"selectedAccountReference\": null}\n")
